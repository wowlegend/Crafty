...
const FILL = { health: 'bg-danger', mana: 'bg-info', hunger: 'bg-warn', xp: 'bg-accent', ferocity: 'bg-ferocity' };
const ICON_COLOR = { health: 'text-danger', mana: 'text-info', hunger: 'text-warn', xp: 'text-accent', ferocity: 'text-ferocity' };
