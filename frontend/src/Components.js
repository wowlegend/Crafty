...
export const Player = ({ gameState }) => {
  ...
  // NO DUPLICATE KEY HANDLERS - Let FixedPlayer.js handle movement keys
  // Removed keydown event listener to prevent conflicts with FixedPlayer.js
