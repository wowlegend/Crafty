...
const gameScene = () => readFileSync(resolve(SRC, 'GameScene.jsx'), 'utf8') + readFileSync(resolve(SRC, 'render/BloomSpikeDriver.jsx'), 'utf8'); // A2.3: bloom-spike driver moved -> src/render/
