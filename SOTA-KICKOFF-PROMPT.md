...
**Guardrails**: verify doc-claims vs code; perf for web/iPad/mobile+touch; premium taste on every visual; no new slop (lock vision before building); a young player joy + Chinese language; no Claude/AI footer in commits; this is its own repo (separate from moneymaker).
