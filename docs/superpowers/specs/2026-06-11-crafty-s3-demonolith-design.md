...
| S3-M4 | **AdvancedGameFeatures dissolve, part 1** | The four unrelated domains begin separating (survival/boss/pets/talent-panel); 6 gate files incl. 2 position-sensitive indexOf gates — the lens's unit map governs | Medium safety; after the pattern is 3×-proven |
