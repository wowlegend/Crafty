...
- 2026-06-16: **M3 Settings/a11y (#3) + touch dodge (#6) IN PROGRESS** — plan authored; S1 feedback slider + S2 reduced-motion + S3a SFX-volume slider DONE (`c5d1b7d`/`ab8d96c`/`b1bd1cf`: audioGain -> master-bus gain). 1352 tests / 20/20. NEXT: S3b music volume + master mute, S4 touch dodge.
