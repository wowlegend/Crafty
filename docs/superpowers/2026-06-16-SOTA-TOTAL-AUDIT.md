...
- 2026-06-16: **M4 living world IN PROGRESS** -- plan authored; S1a grass-top worker emit DONE (`bd9ab34`: pure grassField.grassTops + worker scans column tops -> sparse grassTops[] on the chunk payload; data-only). 1367 tests / 20/20. NEXT: 1b mount OptimizedGrassSystem per chunk (visible grass, deliberate re-baseline), then S2 landmarks #8 / S3 far-LOD #18 / S4 biomes #12.
