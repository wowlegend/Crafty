...
- 2026-06-16: **M3 Settings/a11y (#3) + touch dodge (#6) IN PROGRESS** — plan authored; S1 feedback-intensity slider DONE (`c5d1b7d`: surfaces the M1 juiceIntensity dial in SettingsPanel, LOOK-verified). 1339 tests / 20/20. NEXT: S2 reduced-motion hook, S3 audio mute/sliders, S4 touch dodge.
